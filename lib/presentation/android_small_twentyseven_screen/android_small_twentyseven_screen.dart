...
class AndroidSmallTwentysevenScreen
    extends GetWidget<AndroidSmallTwentysevenController> {
  @override
                    ...
                    children: [
                      ...
                      Align(
                          ...
                          child: Padding(
                              ...
                              child: Text("msg_im_looking_for".tr,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
                      ...
                      Align(
                          ...
                          child: Container(
                              ...
                              child: Text("msg_your_name_helps2".tr,
                                  maxLines: null,
                                  textAlign: TextAlign.left,
                                  style: AppStyle
                      ...
                      CustomButton(
                          height: 44,
                          width: 312,
                          text: "lbl_2_flatmates".tr,
                          margin: getMargin(top: 16)),
                      CustomButton(
                          height: 44,
                          width: 312,
                          text: "lbl_3_flatmates".tr,
                          margin: getMargin(top: 16, bottom: 222))
                    ])),
